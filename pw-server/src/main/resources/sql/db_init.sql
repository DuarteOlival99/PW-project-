...
CREATE TABLE public.product_precautions (
	...
	description varchar(255) NULL,
	precaution_type varchar(255) NOT NULL,
	created_by varchar(50) NOT NULL, 
	created_date timestamp NULL,
	last_modified_by varchar(50) NULL,
	last_modified_date timestamp NULL,
	CONSTRAINT pk_product_precautions PRIMARY KEY (id),
	CONSTRAINT fk_product_id FOREIGN KEY (product_id) REFERENCES public.product (id)

);

DROP table if exists public.product_sale cascade;
...
DROP table if exists public.product_sale_product cascade;
CREATE TABLE public.product_sale_product (
	product_id BIGSERIAL NOT NULL,
	sale_id BIGSERIAL NOT NULL,
	CONSTRAINT product_sale_product_pkey PRIMARY KEY (product_id, sale_id ),
	CONSTRAINT fk_product_id FOREIGN KEY (product_id) REFERENCES public.product(id),
	CONSTRAINT fk_sale_id FOREIGN KEY (sale_id) REFERENCES public.product_sale(id)
);
